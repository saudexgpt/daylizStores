    ...
    <el-tabs v-model="activeActivity">
      ...
      <el-tab-pane v-if="user.can_edit" v-loading="updating" label="Update Password" name="second">
        ...
        <el-form-item label="Old Password">
          <el-input v-model="form.password" type="password" :disabled="user.role === 'admin'" />
        </el-form-item>
        <el-form-item label="New Password">
          <el-input v-model="form.new_password" type="password" :disabled="user.role === 'admin'" />
        </el-form-item>
        <el-form-item label="Confirm New Password">
          <el-input v-model="form.c_password" type="password" :disabled="user.role === 'admin'" />
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    updatePassword() {
      if (this.form.new_password !== this.form.c_password) {
        this.$alert('New Password Confirmation does not match');
        return false;
      }
      this.updating = true;
