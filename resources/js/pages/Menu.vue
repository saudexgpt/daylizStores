          ...
          <div class="item-panel">
            ...
            <span class="price-box">
              ...
              <div>
                ...
                <el-tooltip effect="dark" content="Add to cart" placement="top-start">
                  <el-button circle type="primary" @click="addItemToCart(item)"><i class="el-icon-shopping-cart-2" /> </el-button>
                </el-tooltip>
                <!-- <el-tooltip class="pull-right" effect="dark" content="Add to wishlist" placement="top-start">
                  <el-button circle @click="addItemToWishlist(item)"><i class="fas fa-heart" /></el-button>
                </el-tooltip>
