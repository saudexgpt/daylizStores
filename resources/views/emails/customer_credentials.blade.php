                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-font-size"
                                ...
                                <strong>Customer Login Credentials<br /></strong>
                              </h1>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div style="color: #4b4a4a; line-height: 190%; text-align: left; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 16px; line-height: 30.4px;">We are glad to have you as one of our
                                    valuable customers. Your login credential is:
                                    <br /></span></p>
                                <p>
                                  <span>
                                    <div>
